...
class Calculator extends Component {
	state = {
		// value to be displated in <Display />
		displayValue: '0',
	...
	callOperator = () => {
		...
		// converts the displayValue to a string
	...
	updateDisplay = value => {
		...
		if(value === 'ce') {
			// deleted last char in displayValue
